...
log_path_list = []
log_path_list.append(os.path.join(get_controller_path(),"sim_alg/train_and_test_es_with_dhf/log-train_es_ggm_dhf/train_es_ggm_dhf-2024-November-29-10-21-26-ail/ES_GGM.reward.final.txt"))
